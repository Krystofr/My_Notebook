...
import com.krystofrapp.mynotebook.adapters.NotesAdapter;
import com.krystofrapp.mynotebook.callbacks.MainActionModeCallback;
import com.krystofrapp.mynotebook.callbacks.NoteEventListener;
...
import com.krystofrapp.mynotebook.utils.NoteUtils;
...
import static com.krystofrapp.mynotebook.EditNoteActivity.NOTE_EXTRA_Key;
...
public class MainActivity extends AppCompatActivity implements NoteEventListener, Drawer.OnDrawerItemClickListener {
       ...
       // List<IDrawerItem> stockyItems = new ArrayList<>(); removed on materialdrawer 7.0.0
        ...
        AccountHeader header = new AccountHeaderBuilder().withActivity(this)
                .addProfiles(new ProfileDrawerItem()
                        .withEmail("krystofrnanju@gmail.com")
                        .withName("n.k.nDev")
                        .withIcon(R.mipmap.ic_launcher_round))
                .withSavedInstance(savedInstanceState)
                .withHeaderBackground(R.drawable.ic_launcher_background)
                .withSelectionListEnabledForSingleProfile(true) // we need just one profile, else show dropdown
                .build();
    ...
    private void swipeToDelete(final Note swipedNote, final RecyclerView.ViewHolder viewHolder) {
        new AlertDialog.Builder(MainActivity.this)
                ...
                .setNegativeButton("BRING BACK", (dialogInterface, i) -> {
